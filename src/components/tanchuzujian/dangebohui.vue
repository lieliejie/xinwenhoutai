<template>
  ...
  <div class="tip-modal" v-if="zongcangku.isdbohui">
    <div class="tip-box">
      <p>确定要驳回 {{`"${zongcangku.shoudangqian.biaoTi}"`}} 新闻吗</p>
...
let bohui = async () => {
    ...
    zongcangku.isfbbhtishi = true
        ...
        zongcangku.isdbohui = false; // 无论成功与否都关闭弹窗
    }
}
